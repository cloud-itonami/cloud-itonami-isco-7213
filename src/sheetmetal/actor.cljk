(ns sheetmetal.actor
  "SheetMetalWorkerActor — the ISCO-08 7213 sheet-metal workshop
  ...
  The unconditional invariant: the Sheet Metal Worker Advisor can
  never directly commit an operating record the SheetMetalWorkerGovernor
  ...
  SCHEDULING/LOGISTICS ONLY — it never performs sheet-metal work or
  authorizes cutting/forming operations itself."
...
(defn build-graph
  "Build a compiled SheetMetalWorkerActor graph. `store` implements
  `sheetmetal.store/Store`. `advisor` implements
  `sheetmetal.advisor/Advisor` (defaults to `mock-advisor`).
