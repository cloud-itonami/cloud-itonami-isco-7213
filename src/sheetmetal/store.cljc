(ns sheetmetal.store
  "SSoT for the ISCO-08 7213 sheet-metal workshop scheduling/logistics
  ...
  task/materials-usage/progress-record logging and sheet-metal-materials
  supply-order coordination for a sheet-metal fabrication crew under
  this advisor/governor pair, which never dispatches hardware itself,
  never performs metalworking itself, and never finalizes a
  metal-cutting/forming-execution decision or overrides a shop safety
  ...
  (and closely on cloud-itonami-isco-9311's mininglabor.store for the
  physical-safety-domain shape).

  Domain:

    worker   — a registered sheet-metal fabrication crew member
               (:worker-id, :name)
    workshop — a registered sheet-metal workshop {:workshop-id :name
