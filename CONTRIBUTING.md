...
`cloud-itonami-isco-7213` accepts contributions to the OSS actor, policy tests,
...
- Do not commit real worker, workshop or operator data, credentials or operating
  documents.
- Keep production writes and disclosures behind Sheet Metal Worker Governor.
...
- Never widen the closed op-allowlist to include a metal-cutting/forming-execution
