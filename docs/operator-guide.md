...
- safety-critical escalation path (cut hazard, machine-press hazard,
  equipment-condition concern)
...
- a hard, unconditional block on any attempt to route a
  metal-cutting/forming-execution decision, or a shop-safety-officer
